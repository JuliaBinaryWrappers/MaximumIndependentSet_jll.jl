# `MaximumIndependentSet_jll.jl` (v0.1.3+0)

[![deps](https://juliahub.com/docs/MaximumIndependentSet_jll/deps.svg)](https://juliahub.com/ui/Packages/MaximumIndependentSet_jll/12xn0?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/005b40b8e57b956108ff0d9d0d3ca7a61de097a1/M/MaximumIndependentSet/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `MaximumIndependentSet_jll.jl` have been built from these sources:

* git repository: https://github.com/claud10cv/MaximumIndependentSet.git (revision: `e0cb96071fec44be214f3c9f874b5755e9257726`)

## Platforms

`MaximumIndependentSet_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `MaximumIndependentSet_jll.jl`:
